                ...
                <ul className="space-y-3 font-medium w-full flex flex-col">
                        <li>
                            <a
                                ...
                                className={` w-full flex items-center px-4 py-3 text-body rounded-xl hover:text-fg-brand group  ${
                                    active === "Dashboard"
                        ...
                        <li>
                            <a href="#" 
                                ...
                                className={` w-full flex items-center px-4 py-2 text-body rounded-xl hover:text-fg-brand group ${
                                    active === "Tasks"
                                        ? "bg-[#1D1634] text-white"
                                        : "hover:bg-gray-700"
                                }`}
                        ...
                        <li>
                            ...
                            className={` w-full flex items-center px-4 py-2 text-body rounded-xl hover:text-fg-brand group ${
                                ...
                                <span className="ms-3">Goals</span>
                            </a>
                        </li>
                        <li>
                            <a href="#" 
